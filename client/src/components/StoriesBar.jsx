      ...
      <div className="flex gap-4 pb-5">
        ...
        {stories.map((story, index) => (
          <div
            ...
            className={`relative rounded-lg shadow min-w-30 max-x-30 max-h-40 cursor-pointer hover:shadow-lg transition-all duration-200 bg-linear-to-b from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95`}
            key={index}
          >
            <img
            ...
            {story.media_type !== "text" && (
              <div className="absolute inset-0 z-1 rounded-lg bg-black overflow-hidden">
                {story.media_type === "image" ? (
                  <img
                    src={story.media_url}
                    className="h-full w-full object-cover hover:scale-z-105 transition duration-500 opacity-70 hover:opacity-80"
                    alt=""
                  />
                ) : (
                  <video
